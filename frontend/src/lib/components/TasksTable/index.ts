...
export { default as DTTaskTypeCell } from "./task-type-cell.svelte";
export { default as DTTaskStatusCell } from "./task-status-cell.svelte";
...
export { default as DTExecutorsCell } from "./executors-cell.svelte";