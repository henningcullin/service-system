<script lang="ts ">
    ...
    import { report, account } from '$stores';
...
<div class="flex space-x-4">
    <Button
        ...
        disabled={$isCreating || !$account?.role?.report_create}
    ...
    <Button
        ...
        disabled={$isEditing || !$id || !$account?.role?.report_edit}
    ...
    <Button
        ...
        disabled={!$id || !$account?.role?.report_delete}
