...
<div class="ui middle aligned center aligned grid">
    <div class="column">
        ...
        <form class="ui large form {type === 'EMAIL' ? '' : 'hidden'}" on:submit|preventDefault={submitEmailForm}>
        ...
        <form class="ui large form {type !== 'EMAIL' ? '' : 'hidden'}" on:submit|preventDefault={submitLoginForm}>
            <div class="ui stacked">
                <div class="field">
                    <input class="ui input" type="email" readonly bind:value={email} />
                </div>
                <div class="field">
                    <input type="text" placeholder="code" class={type === 'OTP' ? '' : 'hidden'} bind:value={code} />
                </div>
                <div class="field">
                    <input
                        type="password"
